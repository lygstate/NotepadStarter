...
#define lfullpath _wfullpath
#define lstat _wstat
#define lstrncpy wcsncpy
#define lmb2tc mbstowcs
#else
#define lsprintf sprintf
#define lstrupr _strsupr
#define lstrstr strstr
#define lstrncat strncat
#define lfullpath _fullpath
#define lstat _stat
#define lstrncpy strncpy
#define lmb2tc strncpy
#endif
...
public:
	...
	BOOL  SetMenuDefaultItem(UINT uItem, BOOL bByPos = FALSE);
