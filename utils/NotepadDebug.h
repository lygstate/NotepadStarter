...
#define DBGW0(msg)                               _RPTW1(_CRT_WARN, TEXT(MDBG_COMP) TEXT(##msg##) TEXT(__FILE__) L"(%d)\n", __LINE__)
#define DBGW1(msg, arg1)                         _RPTW2(_CRT_WARN, TEXT(MDBG_COMP) TEXT(##msg##) L"\t" TEXT(__FILE__) L"(%d)\n", arg1, __LINE__)
#define DBGW2(msg, arg1, arg2)                   _RPTW3(_CRT_WARN, TEXT(MDBG_COMP) TEXT(##msg##) L"\t" TEXT(__FILE__) L"(%d)\n", arg1, arg2, __LINE__)
